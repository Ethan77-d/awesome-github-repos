...
*   [Python51888/Midscene-Python](https://github.com/Python51888/Midscene-Python) - Midscene Python 是一个基于AI的UI自动化测试框架，支持Web和Android平台。其核心创新在于使用自然语言驱动自动化任务，通过集成视觉语言模型（如GPT-4V、Qwen2.5-VL、Gemini）来理解用户意图并执行操作.
